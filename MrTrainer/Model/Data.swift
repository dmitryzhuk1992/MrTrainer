...
func initData() {
    ...
    let programForBeginers: Program = Program()
    programForBeginers.identifier = 0
    programForBeginers.title = "For Beginers"
    programForBeginers.image = #imageLiteral(resourceName: "program1")
    programForBeginers.addToExercise(ellipticalMachine)
    programForBeginers.addToExercise(bikeMachine)
    programForBeginers.addToExercise(runningMachine)
